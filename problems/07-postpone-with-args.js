...
const greet = (person) => console.log('Hello ' + person + '!');
const slowGreet = postponeWithArgs(greet, 1000);
slowGreet('Rose').then(result => console.log(result));
slowGreet('Alex').then(result => console.log(result));

const printSum = (num1, num2) => console.log(num1 + num2);
const slowPrintSum = postponeWithArgs(printSum, 500);


console.log(slowPrintSum(4, 3).then(result => console.log(result)));
console.log(slowPrintSum(2, 8).then(result => console.log(result)));
